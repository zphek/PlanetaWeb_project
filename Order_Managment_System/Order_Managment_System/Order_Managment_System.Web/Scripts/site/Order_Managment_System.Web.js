var Order_Managment_System;
(function (Order_Managment_System) {
    var Administration;
    ...
    })(Administration = Order_Managment_System.Administration || (Order_Managment_System.Administration = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Administration;
    (function (Administration) {
...
(function (Order_Managment_System) {
    ...
    })(BasicSamples = Order_Managment_System.BasicSamples || (Order_Managment_System.BasicSamples = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Order_Managment_System.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Order_Managment_System.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Order_Managment_System.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Order_Managment_System) {
    ...
    })(Common = Order_Managment_System.Common || (Order_Managment_System.Common = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Common;
...
(function (Order_Managment_System) {
    ...
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        ...
        (function (CustomersRow) {
            ...
            CustomersRow.nameProperty = 'Email';
...
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        var OrdersDetailsForm = /** @class */ (function (_super) {
            __extends(OrdersDetailsForm, _super);
            function OrdersDetailsForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            OrdersDetailsForm.formKey = 'Default.OrdersDetails';
            return OrdersDetailsForm;
        }(Serenity.PrefixedContext));
        Default.OrdersDetailsForm = OrdersDetailsForm;
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        var OrdersDetailsRow;
        (function (OrdersDetailsRow) {
            OrdersDetailsRow.idProperty = 'OrderDetailsId';
            OrdersDetailsRow.localTextPrefix = 'Default.OrdersDetails';
            OrdersDetailsRow.deletePermission = 'Administration:General';
            OrdersDetailsRow.insertPermission = 'Administration:General';
            OrdersDetailsRow.readPermission = 'Administration:General';
            OrdersDetailsRow.updatePermission = 'Administration:General';
        })(OrdersDetailsRow = Default.OrdersDetailsRow || (Default.OrdersDetailsRow = {}));
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        var OrdersDetailsService;
        (function (OrdersDetailsService) {
            OrdersDetailsService.baseUrl = 'Default/OrdersDetails';
            [
                'Create',
                'Update',
                'Delete',
                ...
                OrdersDetailsService[x] = function (r, s, o) {
                    return Q.serviceRequest(OrdersDetailsService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(OrdersDetailsService = Default.OrdersDetailsService || (Default.OrdersDetailsService = {}));
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
        ...
        var OrdersForm = /** @class */ (function (_super) {
            ...
            function OrdersForm(prefix) {
                ...
                if (!OrdersForm.init) {
                    ...
                    var w4 = Default.OrdersDetailsEditor;
...
(function (Order_Managment_System) {
    ...
    (function (Default) {
        ...
        (function (OrdersRow) {
            ...
            OrdersRow.nameProperty = 'Status';
            OrdersRow.localTextPrefix = 'Default.Orders';
            OrdersRow.lookupKey = 'Default.Orders';
            function getLookup() {
                return Q.getLookup('Default.Orders');
            }
            ...
            OrdersRow.readPermission = 'Default:Orders:View';
...
(function (Order_Managment_System) {
    ...
    })(Membership = Order_Managment_System.Membership || (Order_Managment_System.Membership = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Membership;
...
(function (Order_Managment_System) {
    ...
    (function (Modules) {
        ...
        (function (Default) {
            var Orders;
            (function (Orders) {
                var OrdersRepresentativesRow;
                (function (OrdersRepresentativesRow) {
                    OrdersRepresentativesRow.idProperty = 'RepresentativeId';
                    OrdersRepresentativesRow.localTextPrefix = 'Default.OrdersRepresentatives';
                    OrdersRepresentativesRow.deletePermission = 'Default:Orders:View';
                    OrdersRepresentativesRow.insertPermission = 'Default:Orders:View';
                    OrdersRepresentativesRow.readPermission = 'Default:Orders:View';
                    OrdersRepresentativesRow.updatePermission = 'Default:Orders:View';
                })(OrdersRepresentativesRow = Orders.OrdersRepresentativesRow || (Orders.OrdersRepresentativesRow = {}));
            })(Orders = Default.Orders || (Default.Orders = {}));
        })(Default = Modules.Default || (Modules.Default = {}));
    })(Modules = Order_Managment_System.Modules || (Order_Managment_System.Modules = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Modules;
...
(function (Order_Managment_System) {
    ...
    })(Northwind = Order_Managment_System.Northwind || (Order_Managment_System.Northwind = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Northwind;
...
(function (Order_Managment_System) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Order_Managment_System.Northwind.Gender', 'Order_Managment_System.Northwind.Entities.Gender');
    })(Northwind = Order_Managment_System.Northwind || (Order_Managment_System.Northwind = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
...
(function (Order_Managment_System) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'Order_Managment_System.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = Order_Managment_System.Northwind || (Order_Managment_System.Northwind = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
...
(function (Order_Managment_System) {
    ...
    })(Authorization = Order_Managment_System.Authorization || (Order_Managment_System.Authorization = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Administration;
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Order_Managment_System.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Order_Managment_System.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Order_Managment_System.Common.ReportHelper.execute({
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Order_Managment_System.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Order_Managment_System.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Order_Managment_System.Northwind.OrderDialog();
                        ...
                        var chai = Order_Managment_System.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Order_Managment_System.Northwind.EmployeeRow.getLookup().items
        ...
        }(Order_Managment_System.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Order_Managment_System.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.OrderDialog));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Order_Managment_System.Northwind.CategoryService.Retrieve({
        ...
        }(Order_Managment_System.Northwind.CategoryDialog));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Order_Managment_System.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Order_Managment_System.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Order_Managment_System.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Order_Managment_System.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Order_Managment_System.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Order_Managment_System.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Order_Managment_System.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Order_Managment_System.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Order_Managment_System.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Order_Managment_System.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Order_Managment_System.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return Order_Managment_System.LanguageList.getValue();
            };
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.SupplierDialog));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Order_Managment_System.Northwind.SupplierGrid));
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Order_Managment_System.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Order_Managment_System.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Order_Managment_System.Northwind.CustomerDialog));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.CustomerGrid));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Order_Managment_System.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(Order_Managment_System.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Order_Managment_System.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Order_Managment_System.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Order_Managment_System.Northwind.OrderDetailDialog));
...
(function (Order_Managment_System) {
    ...
    (function (Northwind) {
        ...
        }(Order_Managment_System.Common.GridEditorBase));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Northwind.OrderDetailsEditor));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Order_Managment_System.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Order_Managment_System.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Order_Managment_System.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Order_Managment_System.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Order_Managment_System.BasicProgressDialog();
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        ...
        }(Order_Managment_System.Common.BulkServiceAction));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Order_Managment_System.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Order_Managment_System.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Order_Managment_System.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Order_Managment_System.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Order_Managment_System.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Order_Managment_System.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Order_Managment_System.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Order_Managment_System) {
    ...
    Order_Managment_System.SelectableEntityGrid = SelectableEntityGrid;
})(Order_Managment_System || (Order_Managment_System = {}));
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Order_Managment_System.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Order_Managment_System.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Order_Managment_System.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Order_Managment_System.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Order_Managment_System.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Order_Managment_System.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Order_Managment_System.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Order_Managment_System.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Order_Managment_System.Northwind.ProductService.baseUrl; };
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Order_Managment_System.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Order_Managment_System.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Order_Managment_System.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Order_Managment_System.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Order_Managment_System) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Order_Managment_System.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Order_Managment_System.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Order_Managment_System.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Order_Managment_System) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Order_Managment_System.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Order_Managment_System.LanguageList || (Order_Managment_System.LanguageList = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
...
(function (Order_Managment_System) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Order_Managment_System.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Order_Managment_System.ScriptInitialization || (Order_Managment_System.ScriptInitialization = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    ...
    Order_Managment_System.BasicProgressDialog = BasicProgressDialog;
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var DialogUtils;
    ...
    })(DialogUtils = Order_Managment_System.DialogUtils || (Order_Managment_System.DialogUtils = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Common;
...
(function (Order_Managment_System) {
    ...
    Order_Managment_System.StaticTextBlock = StaticTextBlock;
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Common;
...
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        var OrdersDetailsDialog = /** @class */ (function (_super) {
            __extends(OrdersDetailsDialog, _super);
            function OrdersDetailsDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Default.OrdersDetailsForm(_this.idPrefix);
                _this.form.ProductId.changeSelect2(function (e) {
                    var productId = Q.toId(_this.form.ProductId.value);
                    if (productId != null) {
                        _this.form.Quantity.value = _this.form.Quantity.value || 1;
                        _this.form.UnitPrice.value = Default.ProductsRow.getLookup().itemById[productId].Price;
                        _this.form.Subtotal.value = (_this.form.Quantity.value * _this.form.UnitPrice.value);
                    }
                });
                _this.form.Quantity.change(function (e) {
                    var productId = Q.toId(_this.form.ProductId.value);
                    if (productId != null) {
                        _this.form.Subtotal.value = _this.form.Quantity.value * Default.ProductsRow.getLookup().itemById[productId].Price;
                    }
                });
                return _this;
            }
            OrdersDetailsDialog.prototype.getFormKey = function () { return Default.OrdersDetailsForm.formKey; };
            OrdersDetailsDialog.prototype.getIdProperty = function () { return Default.OrdersDetailsRow.idProperty; };
            OrdersDetailsDialog.prototype.getLocalTextPrefix = function () { return Default.OrdersDetailsRow.localTextPrefix; };
            OrdersDetailsDialog.prototype.getService = function () { return Default.OrdersDetailsService.baseUrl; };
            OrdersDetailsDialog.prototype.getDeletePermission = function () { return Default.OrdersDetailsRow.deletePermission; };
            OrdersDetailsDialog.prototype.getInsertPermission = function () { return Default.OrdersDetailsRow.insertPermission; };
            OrdersDetailsDialog.prototype.getUpdatePermission = function () { return Default.OrdersDetailsRow.updatePermission; };
            OrdersDetailsDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], OrdersDetailsDialog);
            return OrdersDetailsDialog;
        }(Serenity.EntityDialog));
        Default.OrdersDetailsDialog = OrdersDetailsDialog;
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var Order_Managment_System;
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        var OrdersDetailsEditor = /** @class */ (function (_super) {
            __extends(OrdersDetailsEditor, _super);
            function OrdersDetailsEditor(container) {
                return _super.call(this, container) || this;
            }
            OrdersDetailsEditor.prototype.getColumnsKey = function () { return "Default.OrdersDetails"; };
            OrdersDetailsEditor.prototype.getDialogType = function () { return Default.OrdersDetailsDialog; };
            OrdersDetailsEditor.prototype.getLocalTextPrefix = function () { return Default.OrdersDetailsRow.localTextPrefix; };
            OrdersDetailsEditor.prototype.validateEntity = function (row, id) {
                row.ProductId = Q.toId(row.ProductId);
                var sameProduct = Q.tryFirst(this.view.getItems(), function (x) { return x.ProductId === row.ProductId; });
                if (sameProduct && this.id(sameProduct) !== id) {
                    Q.alert('This product is already in order details!');
                ...
                row.ProductName = Default.ProductsRow.getLookup().itemById[row.ProductID].ProductName;
                row.Subtotal = (row.Quantity || 0) * (row.UnitPrice || 0);
                return true;
            };
            OrdersDetailsEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], OrdersDetailsEditor);
            return OrdersDetailsEditor;
        }(Order_Managment_System.Common.GridEditorBase));
        Default.OrdersDetailsEditor = OrdersDetailsEditor;
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    var Default;
    (function (Default) {
        var OrdersDetailsGrid = /** @class */ (function (_super) {
            __extends(OrdersDetailsGrid, _super);
            function OrdersDetailsGrid(container) {
                return _super.call(this, container) || this;
            }
            OrdersDetailsGrid.prototype.getColumnsKey = function () { return 'Default.OrdersDetails'; };
            OrdersDetailsGrid.prototype.getDialogType = function () { return Default.OrdersDetailsDialog; };
            OrdersDetailsGrid.prototype.getIdProperty = function () { return Default.OrdersDetailsRow.idProperty; };
            OrdersDetailsGrid.prototype.getInsertPermission = function () { return Default.OrdersDetailsRow.insertPermission; };
            OrdersDetailsGrid.prototype.getLocalTextPrefix = function () { return Default.OrdersDetailsRow.localTextPrefix; };
            OrdersDetailsGrid.prototype.getService = function () { return Default.OrdersDetailsService.baseUrl; };
            OrdersDetailsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], OrdersDetailsGrid);
            return OrdersDetailsGrid;
        }(Serenity.EntityGrid));
        Default.OrdersDetailsGrid = OrdersDetailsGrid;
    })(Default = Order_Managment_System.Default || (Order_Managment_System.Default = {}));
})(Order_Managment_System || (Order_Managment_System = {}));
var Order_Managment_System;
(function (Order_Managment_System) {
    ...
    (function (Default) {
        var ProductsDialog = /** @class */ (function (_super) {
            ...
            ProductsDialog.prototype.getDeletePermission = function () { return Default.ProductsRow.deletePermission; };
            ProductsDialog.prototype.getInsertPermission = function () { return Default.ProductsRow.insertPermission; };
            ProductsDialog.prototype.getUpdatePermission = function () { return Default.ProductsRow.updatePermission; };
...
(function (Order_Managment_System) {
    ...
    (function (Default) {
        var ProductsGrid = /** @class */ (function (_super) {
            ...
            ProductsGrid.prototype.getInsertPermission = function () { return Default.ProductsRow.insertPermission; };
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Order_Managment_System.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=Order_Managment_System.Web.js.map